...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int ofIndex = locationObject.indexOf("of");
        int locationLength = locationObject.length();
        String offsetText = locationObject.substring(0, ofIndex + 2);
        String locationCity = locationObject.substring(ofIndex + 3, locationLength);
        ...
        locationTextView.setText(locationCity);
